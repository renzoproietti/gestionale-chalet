...
// The [CustomExpansionPanel] now allows you to modify the gap between panels.
...
class ExpansionPanelList extends StatefulWidget {
  ...
  /// Defines the padding between two [ExpansionPanel] widgets when expanded.
