...
class SezioneLanding extends StatefulWidget {
  @override
  _SezioneLandingState createState() => _SezioneLandingState();

  late final PageController pageController;

  SezioneLanding({required this.pageController});
}

class _SezioneLandingState extends State<SezioneLanding> {
  @override
